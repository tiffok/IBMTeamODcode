...
#read in data
#read in mat file
udata = scipy.io.loadmat("pendigits.mat")
...
X_train, X_test, y_train, y_test = train_test_split(x_pca, a_out, test_size=0.4, random_state=127)
...
y_train_pred1 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores1 = clf.decision_scores_  # raw outlier scores

#raw outlier scores
y_scores = clf.decision_function(X_test)

#generate predictions
y_preds = clf.fit_predict(X_test)
...
predplot(y_pred)
actualplot(y_test)
modelEvals(y_test,y_pred, y_scores, df1)
...
# get the prediction labels and outlier scores of the training data
y_train_pred2 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores2 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores2 = clf.decision_function(X_test)

#generate predictions
y_preds2 = clf.fit_predict(X_test)

#generate probabilities
proba2 = clf.predict_proba(X_test)
...
predplot(y_pred2)
actualplot(y_test)
modelEvals(y_test,y_pred2, y_scores2,df2)
...
# get the prediction labels and outlier scores of the training data
y_train_pred3 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores3 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores3 = clf.decision_function(X_test)

#generate predictions
y_preds3 = clf.fit_predict(X_test)

#generate probabilities
proba3 = clf.predict_proba(X_test)
...
predplot(y_pred3)
actualplot(y_test)
modelEvals(y_test,y_pred3, y_scores3,df3)
...
# get the prediction labels and outlier scores of the training data
y_train_pred4 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores4 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores4 = clf.decision_function(X_test)

#generate predictions
y_preds4 = clf.fit_predict(X_test)

#generate probabilities
proba4 = clf.predict_proba(X_test)
...
predplot(y_pred4)
actualplot(y_test)
modelEvals(y_test,y_pred4, y_scores4,df4)
...
# get the prediction labels and outlier scores of the training data
y_train_pred5 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores5 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores5 = clf.decision_function(X_test)

#generate predictions
y_preds5 = clf.fit_predict(X_test)

#generate probabilities
proba5 = clf.predict_proba(X_test)
...
predplot(y_pred5)
actualplot(y_test)
modelEvals(y_test,y_pred5, y_scores5,df5)
...
# get the prediction labels and outlier scores of the training data
y_train_pred6 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores6 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores6 = clf.decision_function(X_test)

#generate predictions
y_preds6 = clf.fit_predict(X_test)

#generate probabilities
proba6 = clf.predict_proba(X_test)
...
predplot(y_pred6)
actualplot(y_test)
modelEvals(y_test,y_pred6, y_scores6,df6)
...
# get the prediction labels and outlier scores of the training data
y_train_pred7 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores7 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores7 = clf.decision_function(X_test)

#generate predictions
y_preds7 = clf.fit_predict(X_test)

#generate probabilities
proba7 = clf.predict_proba(X_test)
...
predplot(y_pred7)
actualplot(y_test)
modelEvals(y_test,y_pred7, y_scores7,df7)
...
# get the prediction labels and outlier scores of the training data
y_train_pred8 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores8 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores8 = clf.decision_function(X_test)

#generate predictions
y_preds8 = clf.fit_predict(X_test)

#generate probabilities
proba8 = clf.predict_proba(X_test)
...
predplot(y_pred8)
actualplot(y_test)
modelEvals(y_test,y_pred8, y_scores8,df8)
...
# get the prediction labels and outlier scores of the training data
y_train_pred9 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores9 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores9 = clf.decision_function(X_test)

#generate predictions
y_preds9 = clf.fit_predict(X_test)

#generate probabilities
proba9 = clf.predict_proba(X_test)
...
predplot(y_pred9)
actualplot(y_test)
modelEvals(y_test,y_pred9, y_scores9,df9)
...
# get the prediction labels and outlier scores of the training data
y_train_pred10 = clf.labels_  # binary labels (0: inliers, 1: outliers)
y_train_scores10 = clf.decision_scores_  # raw outlier scores

#generate anomaly scores
y_scores10 = clf.decision_function(X_test)

#generate predictions
y_preds10 = clf.fit_predict(X_test)

#generate probabilities
proba10 = clf.predict_proba(X_test)
...
predplot(y_pred10)
actualplot(y_test)
modelEvals(y_test,y_pred10, y_scores10,df10)
...
fpr1, tpr1, threshold = roc_curve(y_test, proba[:,0], pos_label=0)
auc1 = roc_auc_score(y_test, y_scores)

fpr2, tpr2, threshold2 = roc_curve(y_test, proba2[:,0], pos_label=0)
auc2 = roc_auc_score(y_test, y_scores2)

fpr3, tpr3, threshold3 = roc_curve(y_test, proba3[:,0], pos_label=0)
auc3 = roc_auc_score(y_test, y_scores3)

fpr4, tpr4, threshold4 = roc_curve(y_test, proba4[:,0], pos_label=0)
auc4 = roc_auc_score(y_test, y_scores4)

fpr5, tpr5, threshold5 = roc_curve(y_test, proba5[:,0], pos_label=0)
auc5 = roc_auc_score(y_test, y_scores5)

fpr6, tpr6, threshold6 = roc_curve(y_test,proba6[:,0],  pos_label=0)
auc6 = roc_auc_score(y_test, y_scores6)

fpr7, tpr7, threshold7 = roc_curve(y_test, proba7[:,0], pos_label=0)
auc7 = roc_auc_score(y_test, y_scores7)

fpr8, tpr8, threshold8 = roc_curve(y_test, proba8[:,0], pos_label=0)
auc8 = roc_auc_score(y_test, y_scores8)

fpr9, tpr9, threshold9 = roc_curve(y_test, proba9[:,0], pos_label=0)
auc9 = roc_auc_score(y_test, y_scores9)

fpr10, tpr10, threshold10 = roc_curve(y_test, proba10[:,0], pos_label=0)
auc10 = roc_auc_score(y_test, y_scores10)
...
plt.plot(fpr7, tpr7, color = "mediumvioletred", label = f"MCD Model: AUC = {auc8:.3f}")
plt.plot(fpr7, tpr7, color = "indigo", label = f"OCSVM Model: AUC = {auc9:.3f}")
plt.plot(fpr7, tpr7, color = "slategray", label = f"PCA Model: AUC = {auc10:.3f}")
plt.plot([0, 1], [0, 1], color="navy", linestyle="--")
plt.xlim([-0.05, 1.05])
plt.ylim([-0.05, 1.05])
plt.xlabel("False Positive Rate")
