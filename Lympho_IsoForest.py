...
df = pd.read_csv('/Users/allisonrudolph/OneDrive/Lympho_Dataset.csv', header=None)
X = df.iloc[:, 1:]
Y = df.iloc[:, 1]
...
fig.show()
y_pred = np.where(df["anomaly_label"]==-1, 1, 0)
...
#read in mat file
udata = scipy.io.loadmat("/Users/allisonrudolph/Downloads/lympho.mat")
